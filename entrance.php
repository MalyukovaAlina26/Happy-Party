...
$check_user =  mysqli_query($mysqli, "SELECT * FROM `users` WHERE `tel` = '$tel' AND 
`pass` = '$password'");
...
if( mysqli_num_rows($check_user)>0){
   ...
   header('Location: user/account.php?id='. $user['id'].'');
...
<html>
  ...
  <a class="authorization__admin-txt" href="entrance-admin.php">зайти как администратор</a>
